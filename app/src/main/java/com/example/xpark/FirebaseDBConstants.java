...
public class FirebaseDBConstants {
    ...
    public static final String DB_CARPARK_CHILD_NAME = "name";
    public static final String DB_CARPARK_CHILD_PHONE = "phone";
    public static final String DB_CARPARK_CHILD_PROVINCE = "province";
    public static final String DB_CARPARK_CHILD_DISTRICT = "district";
